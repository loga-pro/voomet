                    ...
                    {currentItems.length > 0 ? (
                      currentItems.map((dispatch) => (
                        <tr key={dispatch._id} className="hover:bg-gray-50 transition-colors duration-150">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statusColors[dispatch.status] || 'bg-gray-100 text-gray-800'}`}>
                              {dispatch.status?.toUpperCase() || 'DISPATCHED'}
                            </span>
                          </td>
