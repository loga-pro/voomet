...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const DropdownIcons = {
    ...
    'Milestone Tracking': (
      <svg className="mr-3 h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5h6m-6 4h6m-6 4h6m-3 4h3" />
      </svg>
    ),
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: "/production-entry-system",
          permission: "purchase_entry_system",
        },
        {
          name: "Inhouse Part Master",
          path: "/inhouse-part-master",
          permission: "inhouse_partmaster",
        },
      ],
    },
    {
