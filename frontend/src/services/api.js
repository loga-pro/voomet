...
export const milestonesAPI = {
  ...
  updateTracking: (id, tasks) =>
    api.patch(`/milestones/${id}/tracking`, { tasks }),
...
export const inhouseMilestonesAPI = {
  ...
  updateTracking: (id, tasks) =>
    api.patch(`/inhouse-milestones/${id}/tracking`, { tasks }),
...
export const dashboardAPI = {
  ...
  getProjectsByStage: (stage) =>
    api.get(`/dashboard/projects-by-stage/${stage}`),
};
...
export const reportsAPI = {
  ...
  generatePDF: (data) =>
    api.post("/reports/generate-pdf", data, {
  ...
  exportCSV: (reportType) =>
    api.get(`/reports/export-csv/${reportType}`, { responseType: "blob" }),
...
export const projectBudgetsAPI = {
  ...
  updateProjectExpenditures: (id, projectExpenditures) =>
    api.patch(`/project-budgets/${id}/project-expenditures`, {
      projectExpenditures,
    }),
  updateLogisticExpenditures: (id, logisticExpenditures) =>
    api.patch(`/project-budgets/${id}/logistic-expenditures`, {
      logisticExpenditures,
    }),
  delete: (id) => api.delete(`/project-budgets/${id}`),
  exportCSV: () =>
    api.get("/project-budgets/export/csv", { responseType: "blob" }),
...
export const projectExpendituresAPI = {
  ...
  getByProject: (projectId) =>
    api.get(`/project-expenditures/project/${projectId}`),
  getByCustomer: (customerId) =>
    api.get(`/project-expenditures/customer/${customerId}`),
  ...
  updateStatus: (id, status) =>
    api.put(`/project-expenditures/${id}/status`, { status }),
  getSummary: (params = {}) =>
    api.get("/project-expenditures/reports/summary", { params }),
  getStatusReport: (params = {}) =>
    api.get("/project-expenditures/reports/status-wise", { params }),
};
...
export const productionAPI = {
  ...
  getProjectsByCustomer: (customerName) =>
    api.get(`/production/customer/${customerName}/projects`),
...
export const purchaseRequestsAPI = {
  getAll: (filters) =>
    api
      .get("/purchase-requests", { params: filters })
      .then((res) => res.data.data || res.data),
  getById: (id) => api.get(`/purchase-requests/${id}`),
  getCustomers: () => api.get("/purchase-requests/customers"),
  getProjects: (customerName) =>
    api.get("/purchase-requests/projects", { params: { customerName } }),
  create: (data) =>
  ...
  updateStatus: (id, status) =>
    api.patch(`/purchase-requests/${id}/status`, { status }),
  delete: (id) => api.delete(`/purchase-requests/${id}`),
  getSummaryReport: (params) =>
    api.get("/purchase-requests/reports/summary", { params }),
  exportCSV: (filters) =>
    api.post("/purchase-requests/export/csv", { filters }),
};
...
export const miscellaneousExpendituresAPI = {
  getAll: (filters) =>
    api.get("/miscellaneous-expenditures", { params: filters }),
  ...
  getFinancialYears: () =>
    api.get("/miscellaneous-expenditures/financial-years"),
  exportCSV: (filters) =>
    api.post(
      "/miscellaneous-expenditures/export/csv",
      { filters },
      {
        responseType: "blob",
      }
