...
const Header = ({ onMenuClick }) => {
  ...
  const getPageTitle = () => {
    const routeTitles = {
      ...
      '/customer-boq': 'Customer BOQ Management',
      '/inhouse-boq': 'InHouse BOQ Management',
      '/milestone-management': 'Plan Creation',
      '/milestone-tracking': 'Milestone Tracking',
      '/inhouse-milestone': 'Inhouse Milestone',
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200 w-full">
      <div className="flex justify-between items-center px-3 sm:px-4 lg:px-5 py-3 sm:py-3">
        <div className="flex items-center">
          ...
          <h1 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 ml-2 lg:ml-0">{getPageTitle()}</h1>
        </div>
