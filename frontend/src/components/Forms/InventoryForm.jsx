...
const InventoryForm = ({ 
  ...
  const addReceipt = () => {
    ...
    const receiptData = {
      ...
      customerVendorName: formData.receiptCustomerVendorName || formData.customerVendorName,
  ...
  const addDispatch = () => {
    ...
    const dispatchData = {
      ...
      customerVendorName: formData.dispatchCustomerVendorName || formData.customerVendorName,
  ...
  const editReceipt = (index) => {
    ...
    setFormData(prev => ({
      ...
      receiptCustomerVendorName: receipt.customerVendorName,
  ...
  const editDispatch = (index) => {
    ...
    setFormData(prev => ({
      ...
      dispatchCustomerVendorName: dispatch.customerVendorName,
