...
const userSchema = new mongoose.Schema({
  ...
  permissions: [{
    ...
    enum: [
      ...
      'milestone_management','inhouse_milestone',  'inventory_management', 'quality_management', 'payment_master', 'project_budget','logistic_expenditure','project_expenditure','purchase_request','production_management', 'reports', 'inhouse_partmaster'
    ]
  }],
  lastLogin: {
    type: Date,
